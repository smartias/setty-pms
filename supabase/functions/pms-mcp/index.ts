...
mcp.tool("list_project_documents", {
  description:
    ...
    "Project Document Library + Documents: drawings, specs, the Email folder of auto-saved attachments, the " +
    "Outgoing folder of submissions, the Project Management folder of meeting minutes) and lists its files, " +
...
mcp.tool("read_document", {
  description:
    ...
    "MEETING MINUTES and DRAWING REVIEW COMMENTS/RESPONSES (often Excel comment logs / " +
    "registers, incl. DrChecks exports — 'Dr. Checks' = the agencies' design-review comment system, so 'Dr. Checks comments' means AGENCY review comments) are high-value — read those in full and note the specific comments and their " +
    "responses. Large files and other binaries (drawings, images, .doc/.ppt) return metadata + a webUrl.",
  inputSchema: z.object({
